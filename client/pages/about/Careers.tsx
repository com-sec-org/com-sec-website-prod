...
export default function Careers() {
  const jobPositions = [
    ...
    },
    {
      ...
      location: "Columbia (3 days on-site, 2 days remote)",
      type: "Full-Time",
      ...
      description:
        "Be the IT backbone for fast-growing startups and businesses in healthcare and technology. At Com-Sec, we help companies deliver secure IT support and manage their infrastructure so they can focus on innovation.",
      responsibilities: [
        "Provide on-site support in Columbia 3 days per week, with remote support on other days",
        ...
        "Administer user identities and access through Microsoft Entra ID",
        "Assist with Amazon Web Services and Microsoft Azure cloud administration",
      ...
      requirements: [
        "2+ years of experience in IT Support, Help Desk, or Systems Administration",
        "Strong experience troubleshooting Microsoft Outlook and Microsoft 365 ecosystem",
        "Hands-on experience with Microsoft Intune and Microsoft Entra ID",
        "Experience supporting Amazon Web Services and/or Microsoft Azure environments",
        "Excellent communication and customer service skills",
        "Ability to prioritize and resolve issues quickly in a fast-paced environment",
        "Must be able to work on-site in Columbia",
        "Proficiency in managing and maintaining desktop computers and related peripherals",
        "Solid understanding of IT principles and best practices",
        "Experience delivering effective Help Desk support and resolving user inquiries efficiently",
        "Ability to manage multiple tasks in a dynamic, remote-friendly environment",
        "Associate's or Bachelor's degree in Information Technology or related field (preferred)",
      ],
      bonusPoints: [
        "Security and compliance experience (SOC 2, HIPAA, ISO 27001, HITRUST)",
        "Experience with MDM, EDR, and endpoint security tools",
        "Knowledge of networking concepts (VPN, DNS, DHCP, firewalls)",
        "Experience with Google Workspace or Okta",
        "Familiarity with PowerShell or Bash scripting/automation",
        "Experience supporting audits, evidence collection, or security questionnaires",
        "Prior experience with IT compliance and security support",
      ],
      tags: ["IT Support", "Microsoft 365", "Cloud", "Full-Time", "Columbia"],
    },
  ];
