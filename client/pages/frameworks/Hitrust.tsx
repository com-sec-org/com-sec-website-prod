      ...
      <section className="pt-24 pb-20 bg-gradient-to-br from-red-900 via-pink-800 to-rose-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            We work with our HITRUST-licensed partners to guide organizations toward 
  achieving compliance with the Health Information Trust Alliance Common 
  Security Framework (HITRUST CSF).
            </p>
