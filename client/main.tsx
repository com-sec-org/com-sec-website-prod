...
//             />
//             <Route
//               path="/blog/difference-between-internal-vs-external-penetration-testing"
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/services/penetration-testing-services" element={<PenetrationTesting />} />
            <Route path="/services/it-support" element={<ItSupport />} />
            <Route path="/services/soc-support" element={<SocSupport />} />
            <Route path="/services/soc2-readiness" element={<Soc2Readiness />} />
            ...
            {/* THIS IS THE SPECIAL OLD URL YOU WANT */}
            <Route
              path="/blog/how-to-prepare-for-a-compliance-audit-best-practices-and-strategies"
              element={<PrepareComplianceAudit />}
            />
